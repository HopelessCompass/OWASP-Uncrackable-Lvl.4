...
1. Перехватываем memcp с помощью следующего хука Frida. Этот хук мне накидал ChatGPT:
```
'use strict';
...
To do:
2. Скормить хук приложению чтобы вычислить алгоритм вычисления валидных значений
3. Написать программу на Python которая будет генерировать валидные значения PIN и количества
4. Оформить отчёт во этом репозитории
